              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                          'Total Saldo: ${CurrencyFormat.convertToIdr(data.totalSaldo, 0)}',
                  ...
                  return Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          title: Text(
                              'Jumlah: ${CurrencyFormat.convertToIdr(penarikan.jumlahPenarikan, 0)}'),
                          trailing: Text(penarikan.status.toString()),
                          subtitle: Text(
                              DateFormat("EEEE, d MMMM yyyy", "id_ID").format(
                                  DateTime.parse(
                                      penarikan.createdAt.toString()))),
                        );
                      },
                    ),
                  );
